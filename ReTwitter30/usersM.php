...
{
$sqli = "INSERT INTO `reply_user` (`id`, `user`, `reply_id`, `accessToken`, `accessTokenSecret`) VALUES (NULL, '".trim(trim(trim($userS)))."', '0','".$access_token_oauth_token."', '".$access_token_oauth_token_secret."');";
